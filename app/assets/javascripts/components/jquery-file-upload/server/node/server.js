...
(function (port) {
    ...
    FileInfo.prototype.initUrls = function (req) {
        if (!this.error) {
            ...
            this.path = this.url = this.delete_url = baseUrl + encodeURIComponent(this.name);
        ...
        var handler = this,
            ...
            finish = function () {
                ...
                if (!counter) {
                    ...
                    handler.callback({files: files,hash: Math.random(),date: Math.round(new Date().getTime())}, redirect);
                }
            };
